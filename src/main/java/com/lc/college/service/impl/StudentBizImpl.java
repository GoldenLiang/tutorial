...
import com.lc.college.dao.StudentDao;
import com.lc.college.service.StudentBiz;
import com.lc.entity.Student;
import com.lc.entity.User;
import com.lc.system.dao.RoleDao;
import com.lc.system.service.UserBiz;
...
public class StudentBizImpl implements StudentBiz {
    ...
    public void add(Student student, MultipartFile pic) throws IOException {
        ...
        if (pic.getSize() != 0) {
            ...
            String path = "/home/lc/software/apache-tomcat-8.0.28/pic/";
